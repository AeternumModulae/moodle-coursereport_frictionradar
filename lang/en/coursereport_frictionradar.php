...
$string['summary_heading'] = 'Course summary';
...
$string['details_label'] = 'View details';
$string['next_step_label'] = 'Next step';
$string['severity_not_applicable'] = 'Not applicable';
$string['severity_low'] = 'Low';
$string['severity_moderate'] = 'Moderate';
$string['severity_high'] = 'High';
$string['severity_critical'] = 'Critical';
$string['action_summary_not_applicable'] = 'Available only when learner activity signals are included.';
